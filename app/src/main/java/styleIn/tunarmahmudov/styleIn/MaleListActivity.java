...
public class MaleListActivity extends AppCompatActivity {
    String officeId;
    String hdId;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent i = new Intent(MaleListActivity.this, AboutUsActivity.class);
            startActivity(i);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView maleListView = (ListView) findViewById(R.id.maleListview);
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if(e == null)
                {
                    if(objects.size() > 0)
                    {
                        ...
                        HdListAdapter adapter = new HdListAdapter(MaleListActivity.this, R.layout.adapter_hdlist_layout, hds);
                        maleListView.setAdapter(adapter);
                    }
                }
                else
                {
        ...
        maleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
                            ...
                            if(objects.size() > 0)
                            {
                                for(ParseObject object: objects)
                                {
                                    if(object.get("name").equals(hName))
                                    {
                                        ...
                                        i.putExtra("contactNumber", object.getString("contactNumber"));
                                        startActivity(i);
                                    }
                                }
